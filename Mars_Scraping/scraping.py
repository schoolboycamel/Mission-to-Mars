...
def mars_facts():
    ...
    # add try/except for error handling 
    try:
        # Use the read_html to scrape the facts table into a dataframe.. we use this with Pandas
...
def hemispheres(browser):
    ...
    browser.visit(url)
    #2 crate the list to hold the images and titles 
...
if __name__ == '__main__':
    ...
    # If running as scropt, print scraped data 
    print(scrape_all())
